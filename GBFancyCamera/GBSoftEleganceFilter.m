...
@interface GBSoftEleganceFilter () {
...
@implementation GBSoftEleganceFilter
...
- (id)init;
{
    ...
    UIImage *image1 = [UIImage imageNamed:BundledResource(@"lookup_soft_elegance_1.png")];
    UIImage *image2 = [UIImage imageNamed:BundledResource(@"lookup_soft_elegance_2.png")];
#else
    NSImage *image1 = [NSImage imageNamed:BundledResource(@"lookup_soft_elegance_1.png")];
    NSImage *image2 = [NSImage imageNamed:BundledResource(@"lookup_soft_elegance_2.png")];
#endif
...
-(NSString *)localisedName {
    return NSLocalizedStringFromTableInBundle(@"Elegance", @"GBFancyCameraLocalizations", [[GBFancyCamera class] resourcesBundle], @"filter name");
}
